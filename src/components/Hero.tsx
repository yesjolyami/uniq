  ...
  return (
    <section className="relative flex items-center min-h-[100svh] md:min-h-[85vh] pt-24 pb-20 md:pt-32 md:pb-32 overflow-hidden bg-slate-50">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-white/95 via-white/80 to-white/30 md:bg-gradient-to-r md:from-white md:via-white/30 md:to-transparent"></div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl">
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg text-gray-700 mb-8 sm:mb-10 leading-relaxed max-w-[500px]"
          >
          ...
          >
            ...
            <button 
              ...
              className="w-full sm:w-auto bg-white/50 backdrop-blur-sm sm:bg-transparent border border-slate-300 sm:border-slate-800 hover:bg-slate-50 hover:border-slate-900 text-slate-900 px-8 py-3.5 rounded-full text-base font-semibold transition-all active:scale-[0.98]"
            >
              О компании
            </button>
          </motion.div>
